            ...
            foreach ($userrecords as $userrecord) {
                ...
                if ($user) {
                    ...
                    if (!empty($subquerytimeconditions)) {
                        $subtimes = $this->subquerytimeconditions("user{$userrecord->id}", $subquerytimeconditions, $whereparams);
                        $condition .= $subtimes['where'];
                        $subtimesparams = $subtimes['params'];
                    }
                    $subqueryconditions[] = $condition;
                    $subqueryparams = array_merge($subqueryparams, $inuserparams, $subtimesparams);
