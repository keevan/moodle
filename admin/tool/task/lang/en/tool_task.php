...
$string['run_adhoctasks'] = 'Run adhoc tasks';
...
$string['runadhoc_confirm'] = 'Are you sure you want to run these ad hoc tasks now? Tasks will run on the web server and may take some time to complete.';
...
$string['runclassname'] = 'Run all tasks for class name';
$string['runclassnamefailedonly'] = 'Run all failed tasks for class name';
